...
import { ChevronLeft, Zap, CheckCircle2, Wallet, GraduationCap, Trophy, MapPin, BadgePercent } from "lucide-react";
      ...
      <nav className="fixed top-0 w-full z-50 glass border-b border-border/40">
        <div className="container flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center text-white font-bold transform -rotate-3">
              <Zap className="w-4 h-4 fill-white text-white" />
            </div>
            <span className="font-bold text-lg tracking-tight hidden sm:inline-block">Autoškola <span className="text-primary">RED</span></span>
          </div>
        </div>
      </nav>
