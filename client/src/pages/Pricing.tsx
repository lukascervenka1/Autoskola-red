        ...
        <Card className={`relative flex flex-col border-2 transition-[box-shadow,border-color] duration-300 hover:shadow-xl ${isHighlighted ? 'border-primary ring-2 ring-primary/20 z-10 shadow-xl' : 'border-border/50 hover:border-primary/50'} ${!item.tag ? 'mt-8' : ''}`}>
            ...
            <CardFooter className="mt-auto pt-6">
                <Link href={registrationUrl} className="w-full">
                    <Button className={`w-full text-lg h-12 ${isHighlighted ? 'bg-primary hover:bg-primary/90' : 'hover:bg-primary hover:text-white hover:border-primary'}`} variant={isHighlighted ? 'default' : 'outline'}>
                        Chci se přihlásit
                    </Button>
                </Link>
            </CardFooter>
